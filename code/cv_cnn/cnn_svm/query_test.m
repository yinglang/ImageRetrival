...
para.useSVD = 1;
para.dV_sigma = load('dV_sigma.mat');para.dV_sigma=para.dV_sigma.dV_sigma;
para.svmModel = load('svmModel.mat');para.svmModel = para.svmModel.svmModel;
...
for i = 1:9
    ...
    tic
    res(i) = svm_query(file, net, para.svmModel, para);
    toc
